...
********************
Set-AzResourceGroup -Name "msd-plt-shr-we-prod-rg" -Tag @{AccountNo="";ServiceOwner="" ; BussinessArea = ""; CostCenter = ""; Enviornment = "DEV"; Project = ""; Team = ""}

$tags = (Get-AzResourceGroup -Name msd-plt-shr-we-prod-rg).Tags
$tags.add("bc","xyz")
Set-AzResourceGroup -Name "msd-plt-shr-we-prod-rg" -Tag $tags
